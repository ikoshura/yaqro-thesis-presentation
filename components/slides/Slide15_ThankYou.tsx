...
// Copied from Slide01_Title.tsx for use in this slide.
...
export const Slide15_ThankYou = () => (
  <div className="w-full h-full bg-white text-black flex flex-col justify-center items-center p-8 text-center relative">
    <div className="reveal-item" style={{'--delay': '0ms'} as React.CSSProperties}>
        <TelkomLogo className="h-24 md:h-28 w-auto mx-auto mb-8"/>
        <h1 className="font-display text-7xl sm:text-8xl md:text-9xl tracking-tighter text-gray-900">
            Terima Kasih
        </h1>
        <p className="mt-4 font-sans text-xl sm:text-2xl text-gray-600">
            Demikian presentasi yang dapat saya sampaikan.
        </p>
    </div>

    <div className="mt-12 w-full max-w-md border-t-4 border-brand-red pt-8 reveal-item" style={{'--delay': '200ms'} as React.CSSProperties}>
        <h3 className="font-display text-5xl sm:text-6xl text-brand-red">Q & A</h3>
        <p className="font-sans text-lg text-gray-500 mt-2">Sesi tanya jawab dan diskusi.</p>
    </div>

    <div className="absolute bottom-8 text-center text-gray-500 font-semibold text-sm reveal-item" style={{'--delay': '400ms'} as React.CSSProperties}>
      <p>ABRAR ZHARIFAN SYAH - 7708213023</p>
      <p>D4 Teknologi Rekayasa Multimedia - Universitas Telkom</p>
    </div>
  </div>
);